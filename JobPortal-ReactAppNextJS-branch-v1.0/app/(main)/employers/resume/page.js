							...
							<div className="sticky-top">
								<div className="candidate-info company-info">
									...
									<ul>
										...
										<li><a href="company-resume.html" className="active">
						...
						<div className="col-xl-9 col-lg-8 m-b30">
							<div className="job-bx clearfix">
								<div className="job-bx-title clearfix">
									<h5 className="font-weight-700 float-start text-uppercase">Resume</h5>
									<a href="company-manage-job.html" className="site-button right-arrow button-sm float-end">Back</a>
								</div>
								<ul className="post-job-bx browse-job-grid post-resume row">
										...
										<div className="post-bx">
											<div className="d-flex m-b20">
												<div className="job-post-info">
													<h5 className="m-b0"><a href="jobs-profile.html">Ali Tufan</a></h5>
													<p className="m-b5 font-13">
														<a href="javascript:void(0);" className="text-primary">UX / UI Designer </a>
														at Atract Solutions</p>
													<ul>
														<li><i className="fas fa-map-marker-alt"></i>Sacramento, California</li>
														<li><i className="far fa-money-bill-alt"></i> $ 2500</li>
													</ul>
												</div>
											</div>
									...
									<li className="col-lg-6 col-md-6">
										<div className="post-bx">
											<div className="d-flex m-b20">
												<div className="job-post-info">
													<h5 className="m-b0"><a href="jobs-profile.html">Tammy Dixon</a></h5>
													<p className="m-b5 font-13">
														<a href="javascript:void(0);" className="text-primary">UX / UI Designer </a>
														at Atract Solutions</p>
													<ul>
									...
									<li className="col-lg-6 col-md-6">
										<div className="post-bx">
											<div className="d-flex m-b20">
												<div className="job-post-info">
													<h5 className="m-b0"><a href="jobs-profile.html">David kamal</a></h5>
													<p className="m-b5 font-13">
														<a href="javascript:void(0);" className="text-primary">UX / UI Designer </a>
														at Atract Solutions</p>
													<ul>
									...
									<li className="col-lg-6 col-md-6">
										<div className="post-bx">
											<div className="d-flex m-b20">
												<div className="job-post-info">
													<h5 className="m-b0"><a href="jobs-profile.html">John Doe</a></h5>
													<p className="m-b5 font-13">
														<a href="javascript:void(0);" className="text-primary">UX / UI Designer </a>
														at Atract Solutions</p>
													<ul>
