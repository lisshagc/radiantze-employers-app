...
import LogoOnlyHeaderComponent from "@/app/components/common/LogoOnlyHeaderComponent";
export default function RecuriterLogin() {
  ...
  return <> <LogoOnlyHeaderComponent/><div className="page-content">
